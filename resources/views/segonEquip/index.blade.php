...
<div class="modelEquip">
    ...
    <div class="model1">
        <div class="ApartatX4">
            <a href="{{ route('segon.plantilla') }}" class="link-foto-gran">
                <div class="MedioA fotoGran">
                    <img class="plantillaFoto" src="{{ asset('images/segon_equip/plantilla1e.jpg') }}" alt="Plantilla Segon Equip">
                    <span class="text-over-image">Coneix la Plantilla</span>
                </div>
            </a>
        </div>
        <h3>SEGON EQUIP C.F. VILA-SECA TEMPORADA 2024/25</h3>
    </div>
