<form method="POST" action="{{ route('club.events.action.submit', $event) }}">
  ...
  <input type="hidden" name="tipus" value="campus">
  ...
  @error('num_compte') <small class="text-danger d-block">{{ $message }}</small> @enderror
        ...
        <label for="intolerancia_club" style="grid-column:1/-1">Intolerància
          <input id="intolerancia_club" name="intolerancia" type="text" value="{{ old('intolerancia') }}" placeholder="Celíac, lactosa, etc.">
          @error('intolerancia') <small class="text-danger">{{ $message }}</small> @enderror
        </label>
        ...
        {{-- Recollida (acollida matinal) --}}
        <div style="grid-column:1/-1; margin:.25rem 0">
          <input type="hidden" name="recollida" value="0">
          <label for="recollida_club" style="display:flex; gap:.5rem; align-items:center;">
            <input id="recollida_club" type="checkbox" name="recollida" value="1" {{ old('recollida') ? 'checked' : '' }}>
            Farà ús del servei d’acollida al matí (08:00–09:00)
          </label>
          @error('recollida') <small class="text-danger">{{ $message }}</small> @enderror
        </div>
    ...
    <div id="sec-no-club" style="{{ old('es_jugador_club','0')=='0' ? '' : 'display:none' }};grid-column:1/-1">
      <div style="display:grid;gap:.75rem;grid-template-columns:1fr 1fr">
        ...
        <label for="intolerancia" style="grid-column:1/-1">Intolerància
          <input id="intolerancia" name="intolerancia" type="text" value="{{ old('intolerancia') }}" placeholder="Celíac, lactosa, etc.">
          @error('intolerancia') <small class="text-danger">{{ $message }}</small> @enderror
        </label>
        ...
        <div style="grid-column:1/-1; margin:.25rem 0">
          <input type="hidden" name="recollida" value="0">
          <label for="recollida_no" style="display:flex; gap:.5rem; align-items:center;">
            <input id="recollida_no" type="checkbox" name="recollida" value="1" {{ old('recollida') ? 'checked' : '' }}>
            Farà ús del servei d’acollida al matí (08:00–09:00)
          </label>
          @error('recollida') <small class="text-danger">{{ $message }}</small> @enderror
        </div>
