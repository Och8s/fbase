...
{
    Schema::create('jugadors_1er_equip', function (Blueprint $table) {
        $table->id();
        $table->string('nom');
        ...
        $table->json('equips_anteriors')->nullable(); // o ->string() si prefereixes
        $table->timestamps();
    });
}
    ...
    {
        Schema::dropIfExists('jugadors_1er_equip');
    }
};
