...
Route::prefix('escola')->name('escola.')->group(function () {
    ...
    Route::get('/equips/{id}', [EscolaController::class, 'mostrarEquip'])->name('equips.show');
...
Route::get('/patrocinadors/{id}', [PatrocinadorsController::class, 'mostra'])->name('patrocinadors.mostra');
